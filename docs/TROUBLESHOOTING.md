...
Install 2.2.7 or later and update the relay using **Setup server** once. The UI must say the replacement adapter is **verified** or list it under **Tunnel**. A green link-state icon alone is not proof of upstream Internet.
